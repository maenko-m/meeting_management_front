...
const EventsAdmin: React.FC<EventsProps> = ({ disableRoomElements = false, idRoom, showAuthorColumn = false }) => {
                    ...
                    <Table>
                        <TableHead color="secondary">
                            <TableRow>
                                ...
                                {showAuthorColumn && <TableCell>Автор</TableCell>}
                        ...
                        <TableBody>
                            ...
                            currentPageEvents.map((event, index) => (
                                ...
                                <TableRow sx={{
                                    ...
                                    {showAuthorColumn && <TableCell>{event.author.fullName}</TableCell>}
