...
import { Box, ThemeProvider, TextField, Button, Checkbox, FormControlLabel, Select, MenuItem, Typography, TableContainer, Table, TableHead, TableRow, TableCell, Paper, IconButton, Menu, Collapse, TableBody, SelectChangeEvent } from "@mui/material";
                ...
                <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "1em" }}>
                    ...
                    <Box>
                        ...
                        <Box sx={{ display: "flex", gap: 2, justifyContent: "flex-end", marginTop: "17%" }}>
                            <Button variant="outlined" color="secondary" onClick={handleCancel} disabled={saveLoading}>
